        ...
        <header className="text-gray-600 body-font">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
                    ...
                    <NavLink to={'jsonserver'} className={({isActive})=> `mr-5 hover:text-gray-900 ${isActive ? "text-red-600" : null}`}>JSON-Server</NavLink>
                    <NavLink to={'contact'} className={({isActive})=> `mr-5 hover:text-gray-900 ${isActive ? "text-red-600" : null}`}>CONTACT US</NavLink>
                </nav>
